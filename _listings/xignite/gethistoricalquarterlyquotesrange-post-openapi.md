...
paths:
  ...
  /GetHistoricalQuotesRange:
    post:
      ...
      x-api-path-slug: gethistoricalquotesrange-post
      parameters:
      - in: body
        name: body
        schema:
  ...
  /GetHistoricalWeeklyQuotesRange:
    post:
      ...
      x-api-path-slug: gethistoricalweeklyquotesrange-post
      parameters:
      - in: body
        name: body
        schema:
  ...
  /GetHistoricalQuarterlyQuotesRange:
    post:
      ...
      x-api-path-slug: gethistoricalquarterlyquotesrange-post
      parameters:
      - in: body
        name: body
        schema:
